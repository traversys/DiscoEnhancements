function subtleHeader() {
  chrome.storage.local.get("subtle_header", function(data) {
    var discoHeader = document.getElementById("pageHeader");
    ...
    if (data["subtle_header"]) {
      ...
      discoHeader.style.borderImage = discoColor + "10 round";
      discoHeader.style.borderBottom = "6px solid";
      discoHeader.style.height = "unset";
      ...
      discoHeader.style.borderImage = null;
      discoHeader.style.borderBottom = "2px solid #f86e00";
      discoHeader.style.height = "50px";
...
// TODO: Debug DiscoveryRun, DiscoveryAccess, PatternModule
function taxonomyAttrs() {
  chrome.storage.local.get("taxonomy_attrs", function(data) {
    var attrs = document.getElementsByClassName("dataLabel");
    var tables = document.getElementsByClassName("mainTable");
    if (data["taxonomy_attrs"]) {
      tables = document.querySelectorAll('.mainTable');
...
chrome.storage.onChanged.addListener(taxonomyAttrs);
